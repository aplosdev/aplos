<template>
	<section id="article-footer">
		...
		<h2>Comments</h2>
		<p>
			If you have any questions or comments about this post, please feel
		...
		>
			<small
				>Due to some issues with the ActivityPub comments, they are
				currently disabled. Sorry for the inconvenience.</small
			>
		</p>

		<noscript
			><small
				>Heads Up! You <i>need</i> JavaScript to view/write comments or
				to react to the post. So you can't do anything unless you turn
				on JavaScript.</small
			></noscript
		>
		<!-- <MastodonComments
