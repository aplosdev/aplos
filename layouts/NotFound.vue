<template>
	<main>
		<section id="NotFound">
			...
			<h1>Not Found!</h1>
			<p>
				Oops! The page you are looking for has been removed, relocated
				or never existed. Please check the URL or go back to the
				homepage.
				<span v-if="theme.nav.git"
					>If you believe something should be here, feel free to file
					an issue with the button below.</span
				>
			</p>
		</section>
